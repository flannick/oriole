...
class Summary:
    ...
    def __str__(self) -> str:
        ...
        for i, index in enumerate(ParamIndex.all(n_traits)):
            ...
            lines.append(
                f"{index.with_trait_name(self.params.trait_names):<18} "
...
class ParamMetaStats:
    def __init__(self, n_chains_used: int, trait_names: list[str], params0: list[Params], params1: list[Params]):
    ...
    def summary(self) -> Summary:
        ...
        params = Params.from_vec(param_values, self.trait_names)
